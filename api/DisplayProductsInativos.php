...
<head>
    ...
    <title>Painel - Delicias Deia</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="DisplayProductsInativos.php">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Exibir produtos inativos</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Exibir produtos</h1>
                    <p class="mb-4">Aqui está todos os produtos cadastrados da página da <a target="_blank"
